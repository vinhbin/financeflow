  ...
  _createClass(FlipNumbers, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          numberClassName = _this$props.numberClassName,
          nonNumberClassName = _this$props.nonNumberClassName,
          height = _this$props.height,
          width = _this$props.width,
          color = _this$props.color,
          background = _this$props.background,
      ...
      return React.createElement("section", {
        ...
        return !Number.isNaN(parseInt(n, 10)) ? React.createElement("span", (_React$createElement = {
          "aria-hidden": true,
          style: {
            padding: 0
          }
        }, _defineProperty(_React$createElement, "style", nonNumberStyle), _defineProperty(_React$createElement, "key", numberCounter), _React$createElement), n) : nonNumber;
      }));
    }
  }]);
