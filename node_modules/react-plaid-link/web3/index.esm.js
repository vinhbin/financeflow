...
function useScript(_a) {
    ...
    var _c = (0, react.useState)(status ? status.loading : Boolean(src)), loading = _c[0], setLoading = _c[1];
    var _d = (0, react.useState)(status ? status.error : null), error = _d[0], setError = _d[1];
    // Tracks if script is loaded so we can avoid duplicate script tags
    var _e = (0, react.useState)(false), scriptLoaded = _e[0], setScriptLoaded = _e[1];
